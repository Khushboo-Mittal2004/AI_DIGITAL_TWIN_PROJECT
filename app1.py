...
Tell missing skills and roadmap.
"""
...
# -----------------------------
    ...
    with tab1:
        ...
        with col1:
            age = st.number_input(
                "Age", 10, 100,
                int(user_data["Age"]) if user_data is not None else 20
            )
            ...
            selected_taste = st.multiselect(
                "Taste Preferences",
                taste_options,
                default=user_data["TastePreferences"].split(",") if user_data is not None and user_data["TastePreferences"] else []
            )
